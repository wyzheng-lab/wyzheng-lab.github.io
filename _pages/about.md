...
We continuously offer multiple opportunities for Postdoctoral Fellows, PhD Candidates, Master Students, Research Assistants, and Visiting Scholars every year. These positions are supported by the UM Scholarship/Assistantship or funded through various external research projects. 
...
1. Strong motivation for scientific research, with a rigorous, truth-seeking, persistent, and self-driven attitude, as well as the ability to think independently and solve problems;
2. A solid academic background in electrical engineering, mathematical optimization, artificial intelligence, energy economics, or related fields. Applicants with research or practical experience in active distribution networks, electricity markets, or integrated energy system operation will be given priority;
3. A bachelor's and/or master's degree from universities ranked among the top 200 in QS/THE rankings, or from China's 985/211 universities. Applicants with outstanding research achievements may also be considered;
4. Fulfillment of the general admission requirements for postgraduate applicants at the University of Macau. Please refer to: https://grs.um.edu.mo/index.php/prospective-students.

Interested applicants should submit the following application materials:

1. Curriculum vitae;
2. Degree certificates and academic transcripts;
3. Proof of English proficiency, such as IELTS* overall score of 6.0 or above with no sub-score lower than 5.5 or, TOEFL* score of 550 (paper-based examination) / 80 (Internet-based examination) or above or, CET-6 score of 450 or above;
4. Representative publications, limited to first-author works and no more than two papers.

*Note: TOEFL and IELTS scores are valid for two years from the test date.

Please send all application materials by email to **zhengwy13@tsinghua.org.cn** with the following subject line format: 
**[PhD Application] Name - Undergraduate University and Major - Master's University and Major**.
